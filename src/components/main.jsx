        ...
        <div className='px-36 flex items-center gap-32 mt-12' >
            <div>
                ...
                <div className='flex items-center gap-4 '>
                    <button className='px-5 py-2 text-white bg-orange-500 hover:bg-orange-600 duration-75 rounded-lg'>Order Now</button>
                    <button className='flex items-center gap-1 px-3 py-2 border-orange-500 rounded-lg border-2 hover:bg-orange-500 hover:text-white'><RiPlayFill/>Watch Now</button>
                </div>
            </div>
            <div>
